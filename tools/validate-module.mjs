...
const expectedDownloadUrl = "https://github.com/SpencerZPoole/d35e-scent-sense/releases/download/v1.0.0/d35e-scent-sense-v1.0.0.zip";
...
if (manifest) {
  ...
  if (manifest.version !== "1.0.0") fail("module.json version must be 1.0.0");
