...
- The manifest includes release `manifest` and `download` URLs for tag `v0.6.1`.
...
- Live scratch-world product testing verifies item-granted Scent ranges, odor profile precedence, masking suppression, context-manager render controls, and scan execution.
